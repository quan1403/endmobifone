...
<script>
    ...
    if (currentPage1 === "3c.jsp") {
        $("#option-product").val('3C (Cloud Contact Center)')
    }
    if(currentPage1 ==="mobica.jsp"){
      $("#option-product").val('MobiCA')
    }
    if(currentPage1 ==="mobifone-invoice.jsp"){
      $("#option-product").val('MobiFone Invoice')
    }
    if(currentPage1 ==="mobifone-econtract.jsp"){
