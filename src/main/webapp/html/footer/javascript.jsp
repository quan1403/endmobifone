...
<script type="text/javascript" src="js/circular-slider.js"></script>
<!-- lib -->
                    ...
                    <form action="/customer?action=register" method="post">
                        ...
                        <div class="form-group">
                            <select name="product" id="" class="form-control">
                                ...
                                <option value="Giải pháp quản lý thông tin Nguồn thông minh">Giải pháp quản lý thông tin
                                    Nguồn thông minh
                                </option>
                                ...
                                <option value="Hệ thống quản lý tài liệu điện tử">Hệ thống quản lý tài liệu điện tử
                                </option>
                                <option value="Hệ thống Cổng thông tin điện tử">Hệ thống Cổng thông tin điện tử</option>
                                <option value="Hệ thống cơ sở dữ liệu thông tin KT – XH">Hệ thống cơ sở dữ liệu thông
                                    tin KT – XH
                                </option>
                                <option value="Hệ thống Giám sát điện thoại viên">Hệ thống Giám sát điện thoại viên
                                </option>
                                <option value="Giải pháp phần mềm một cửa điện tử liên thông e-Gate">Giải pháp phần mềm
                                    một cửa điện tử liên thông e-Gate
                                </option>
                                ...
                                <option value="Lưu trữ số hóa điện tử tập trung trên nền tảng Big Data">Lưu trữ số hóa
                                    điện tử tập trung trên nền tảng Big Data
                                </option>
                                <option value="Nền tảng tích hợp, chia sẻ dữ liệu cấp Bộ, cấp tỉnh">Nền tảng tích hợp,
                                    chia sẻ dữ liệu cấp Bộ, cấp tỉnh
                                </option>
                                <option value="Cổng dịch vụ công mức độ 3, 4">Cổng dịch vụ công mức độ 3, 4</option>
                                <option value="Hệ thống Quản lý cán bộ công chức, viên chức">Hệ thống Quản lý cán bộ
                                    công chức, viên chức
                                </option>
                            </select>
                        </div>
